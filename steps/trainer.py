...
class Trainer:
    ...
    def __init__(self, model_config, train_config, dls, tokenizer) -> None:
        ...
        if train_config['checkpoint'] is not None:
            self.model = ImageCaptioner(model_config).from_pretrained(train_config['checkpoint'], self.device)
        else:
...
if __name__ == '__main__':
    ...
    train_dl, test_dl = train_test_split(train_config=train_config, model_config=config, data=data, tokenizer=tokenizer)
